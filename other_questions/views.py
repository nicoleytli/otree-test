...
class Demo7(Page):
    form_model = models.Player
    form_fields = ['race1', 'race2', 'race3', 'race4', 'race5', 'race6', 'hisp', 'gender']

    def vars_for_template(self):
        names = ['White', 'Black or African-American', 'American Indian or Alaska Native', 'Asian', ' Native Hawaiian or other Pacific Islander',
                 'Other']
        values = ['race1', 'race2', 'race3', 'race4', 'race5', 'race6']

        mylist = zip(values, names)
